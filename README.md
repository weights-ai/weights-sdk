# Weights TypeScript API Library

[![NPM version](<https://img.shields.io/npm/v/weights.svg?label=npm%20(stable)>)](https://npmjs.org/package/weights) ![npm bundle size](https://img.shields.io/bundlephobia/minzip/weights)
...
> [!NOTE]
> Once this package is [published to npm](https://www.stainless.com/docs/guides/publish), this will become: `npm install weights`
...
```ts
import Weights from 'npm:weights';
...
We are keen for your feedback; please open an [issue](https://www.github.com/stainless-sdks/weights-typescript/issues) with questions, bugs, or suggestions.
