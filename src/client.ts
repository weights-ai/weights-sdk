...
export interface ClientOptions {
  /**
   * Defaults to process.env['WEIGHTS_BEARER_TOKEN'].
   */
   ...
   *
   * Defaults to process.env['WEIGHTS_BASE_URL'].
   */
   ...
   * Set the log level.
   *
   * Defaults to process.env['WEIGHTS_LOG'] or 'warn' if it isn't set.
   */
...
export class Weights {
  ...
  constructor({
    ...
    const options: ClientOptions = {
      bearerToken,
      ...opts,
      baseURL: baseURL || `https://www.weights.com/api/external`,
    };

    this.baseURL = options.baseURL!;
    this.timeout = options.timeout ?? Weights.DEFAULT_TIMEOUT /* 1 minute */;
    ...
    this.logLevel =
      ...
      parseLogLevel(readEnv('WEIGHTS_LOG'), "process.env['WEIGHTS_LOG']", this) ??
      defaultLogLevel;
  ...
  #baseURLOverridden(): boolean {
    return this.baseURL !== 'https://www.weights.com/api/external';
  }
  ...
  static WeightsError = Errors.WeightsError;
